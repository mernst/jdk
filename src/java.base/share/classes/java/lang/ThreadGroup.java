...
public @UsesObjectEquals class ThreadGroup implements Thread.UncaughtExceptionHandler {
    ...
    private @LTEqLengthOf({"threads"}) @NonNegative int ngroups;
    private ThreadGroup[] groups;

    // weakly reachable from this group
    private @LTEqLengthOf({"groups"}) @NonNegative int nweaks;
     ...
     *          an ancestor
     */
    @CFComment({"index: groupSnapshot.length = ngroupsSnapshot by Arrays.copyOf", 
