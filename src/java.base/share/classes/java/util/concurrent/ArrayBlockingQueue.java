...
public class ArrayBlockingQueue<E extends Object> extends AbstractQueue<E>
    ...
    public boolean add(@GuardSatisfied @Modifiable ArrayBlockingQueue<E> this, E e) {
        return super.add(e);
    }
     ...
     */
    public boolean remove(@Modifiable @Shrinkable ArrayBlockingQueue<E> this, @GuardSatisfied @Nullable @UnknownSignedness Object o) {
