...
public @Modifiable class ArrayBlockingQueue<E extends Object> extends AbstractQueue<E>
     ...
     */
    public int drainTo(@GuardSatisfied @CanShrink ArrayBlockingQueue<E> this, @Modifiable Collection<? super E> c) {
     ...
     * @throws IllegalArgumentException      {@inheritDoc}
     */
    public int drainTo(@GuardSatisfied @CanShrink ArrayBlockingQueue<E> this, @Modifiable Collection<? super E> c, int maxElements) {
