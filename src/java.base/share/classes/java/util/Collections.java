...
public class Collections {
    ...
    static class UnmodifiableCollection<E> implements Collection<E>, Serializable {
        ...
        public boolean remove(@GuardSatisfied @Modifiable UnmodifiableCollection<E> this, @UnknownSignedness Object o) {
            throw new UnsupportedOperationException();
        }
    ...
    static class UnmodifiableSequencedCollection<E> extends UnmodifiableCollection<E>
        ...
        public void addFirst(@GuardSatisfied @Modifiable UnmodifiableSequencedCollection<E> this, E e) {
            throw new UnsupportedOperationException();
        }

        public void addLast(@GuardSatisfied @Modifiable UnmodifiableSequencedCollection<E> this, E e) {
            throw new UnsupportedOperationException();
        }
        ...
        public E removeFirst(@GuardSatisfied @Modifiable UnmodifiableSequencedCollection<E> this) {
            throw new UnsupportedOperationException();
        }

        public E removeLast(@GuardSatisfied @Modifiable UnmodifiableSequencedCollection<E> this) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    static class UnmodifiableList<E> extends UnmodifiableCollection<E>
        ...
        public boolean addAll(@GuardSatisfied @Modifiable UnmodifiableList<E> this, int index, Collection<? extends E> c) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void replaceAll(@GuardSatisfied @Modifiable UnmodifiableList<E> this, UnaryOperator<E> operator) {
            throw new UnsupportedOperationException();
        }
        @Override
    ...
    private static class UnmodifiableMap<K,V> implements Map<K,V>, Serializable {
        ...
        @Override
        public void replaceAll(@GuardSatisfied @Modifiable UnmodifiableMap<K,V> this, BiFunction<? super K, ? super V, ? extends V> function) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        public boolean remove(@GuardSatisfied @Modifiable UnmodifiableMap<K,V> this, @UnknownSignedness Object key, @UnknownSignedness Object value) {
            throw new UnsupportedOperationException();
        }
    ...
    private static class UnmodifiableSequencedMap<K,V> extends UnmodifiableMap<K,V> implements SequencedMap<K,V>, Serializable {
        ...
        public Entry<K, V> pollFirstEntry(@GuardSatisfied @Modifiable UnmodifiableSequencedMap<K,V> this) {
            throw new UnsupportedOperationException();
        }

        public Entry<K, V> pollLastEntry(@GuardSatisfied @Modifiable UnmodifiableSequencedMap<K,V> this) {
            throw new UnsupportedOperationException();
        }

        public V putFirst(@GuardSatisfied @Modifiable UnmodifiableSequencedMap<K,V> this, K k, V v) {
            throw new UnsupportedOperationException();
        }

        public V putLast(@GuardSatisfied @Modifiable UnmodifiableSequencedMap<K,V> this, K k, V v) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    static class UnmodifiableNavigableMap<K,V>
        ...
        public Entry<K, V> pollFirstEntry(@GuardSatisfied @Modifiable UnmodifiableNavigableMap<K,V> this)
                                 { throw new UnsupportedOperationException(); }
        public Entry<K, V> pollLastEntry(@GuardSatisfied @Modifiable UnmodifiableNavigableMap<K,V> this)
                                 { throw new UnsupportedOperationException(); }
        @SideEffectFree
    ...
    static class SynchronizedCollection<E> implements Collection<E>, Serializable {
        ...
        public boolean remove(@GuardSatisfied @Modifiable SynchronizedCollection<E> this, @UnknownSignedness Object o) {
    ...
    static class SynchronizedList<E>
        ...
        public boolean addAll(@GuardSatisfied @Modifiable SynchronizedList<E> this, int index, Collection<? extends E> c) {
        ...
        @Override
        public void replaceAll(@GuardSatisfied @Modifiable SynchronizedList<E> this, UnaryOperator<E> operator) {
    ...
    private static class SynchronizedMap<K,V>
        ...
        @Override
        public void replaceAll(@GuardSatisfied @Modifiable SynchronizedMap<K,V> this, BiFunction<? super K, ? super V, ? extends V> function) {
        ...
        @Override
        public boolean remove(@GuardSatisfied @Modifiable SynchronizedMap<K,V> this, @UnknownSignedness Object key, @UnknownSignedness Object value) {
        ...
        implements NavigableMap<K,V>
    {
        ...
        public Entry<K, V> pollFirstEntry(@GuardSatisfied @Modifiable SynchronizedNavigableMap<K,V> this)
                       { synchronized (mutex) { return nm.pollFirstEntry(); } }
        public Entry<K, V> pollLastEntry(@GuardSatisfied @Modifiable SynchronizedNavigableMap<K,V> this)
    ...
    static class CheckedCollection<E> implements Collection<E>, Serializable {
        ...
        public Iterator<E> iterator() {
            ...
            return new Iterator<>() {
                ...
                public void remove(/*@GuardSatisfied @Modifiable Iterator<E> this*/)     {        it.remove(); }
                public void forEachRemaining(Consumer<? super E> action) {
        ...
        public boolean addAll(@GuardSatisfied @Modifiable CheckedCollection<E> this, Collection<? extends E> coll) {
        ...
        implements List<E>
    {
        ...
        public void add(@GuardSatisfied @Modifiable CheckedList<E> this, @IndexOrHigh({"this"}) int index, E element) {
            list.add(index, typeCheck(element));
        }

        public boolean addAll(@GuardSatisfied @Modifiable CheckedList<E> this, int index, Collection<? extends E> c) {
         ...
         */
        @Override
        public void replaceAll(@GuardSatisfied @Modifiable CheckedList<E> this, UnaryOperator<E> operator) {
        ...
        implements Map<K,V>, Serializable
    {
        ...
        @Override
        public void replaceAll(@GuardSatisfied @Modifiable CheckedMap<K,V> this, BiFunction<? super K, ? super V, ? extends V> function) {
        ...
        @Override
        public boolean remove(@GuardSatisfied @Modifiable CheckedMap<K,V> this, @UnknownSignedness Object key, @UnknownSignedness Object value) {
        ...
        static class CheckedEntrySet<K,V> implements Set<Map.Entry<K,V>> {
            ...
            public boolean addAll(@GuardSatisfied @Modifiable CheckedEntrySet<K,V> this, Collection<? extends Map.Entry<K, V>> coll) {
                throw new UnsupportedOperationException();
            }
            ...
            public Iterator<Map.Entry<K,V>> iterator() {
                ...
                return new Iterator<>() {
                    ...
                    public boolean hasNext() { return i.hasNext(); }
                    @SideEffectsOnly("this")
                    public void remove(/*@GuardSatisfied @Modifiable Iterator<E> this*/)     { i.remove(); }
            ...
            public boolean remove(@GuardSatisfied @Modifiable CheckedEntrySet<K,V> this, @UnknownSignedness Object o) {
                if (!(o instanceof Map.Entry))
                    return false;
        ...
        implements NavigableMap<K,V>, Serializable
    {
        ...
        public Entry<K, V> pollFirstEntry(@GuardSatisfied @Modifiable CheckedNavigableMap<K,V> this) {
        ...
        public Entry<K, V> pollLastEntry(@GuardSatisfied @Modifiable CheckedNavigableMap<K,V> this) {
        ...
        implements ListIterator<E>
    {
        ...
        public void set(@GuardSatisfied @Modifiable EmptyListIterator<E> this, E e) { throw new IllegalStateException(); }
        public void add(@GuardSatisfied @Modifiable EmptyListIterator<E> this, E e) { throw new UnsupportedOperationException(); }
    }
    ...
    private static @Unmodifiable class EmptyList<E>
        ...
        @Override
        public void replaceAll(@GuardSatisfied @Modifiable EmptyList<E> this, UnaryOperator<E> operator) {
            Objects.requireNonNull(operator);
        }
        @Override
        public void sort(Comparator<? super E> c) {
        ...
        implements Serializable
    {
        ...
        @Override
        public void replaceAll(@GuardSatisfied @Modifiable EmptyMap<K,V> this, BiFunction<? super K, ? super V, ? extends V> function) {
        ...
        @Override
        public boolean remove(@GuardSatisfied @Modifiable EmptyMap<K,V> this, @UnknownSignedness Object key, @UnknownSignedness Object value) {
            throw new UnsupportedOperationException();
        }
    ...
    private static class SingletonMap<K,V>
        ...
        @Override
        public void replaceAll(@GuardSatisfied @Modifiable SingletonMap<K,V> this, BiFunction<? super K, ? super V, ? extends V> function) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        public boolean remove(@GuardSatisfied @Modifiable SingletonMap<K,V> this, @UnknownSignedness Object key, @UnknownSignedness Object value) {
            throw new UnsupportedOperationException();
        }
        ...
        implements Set<E>, Serializable
    {
        ...
        public boolean remove(@GuardSatisfied @Modifiable SetFromMap<E> this, @UnknownSignedness Object o)   { return m.remove(o) != null; }
        @EnsuresNonEmpty("this")
    ...
    private static class SequencedSetFromMap<E> extends SetFromMap<E> implements SequencedSet<E> {
        ...
        public void addFirst(@GuardSatisfied @Modifiable SequencedSetFromMap<E> this, E e) { map().putFirst(e, Boolean.TRUE); }
        public void addLast(@GuardSatisfied @Modifiable SequencedSetFromMap<E> this, E e)  { map().putLast(e, Boolean.TRUE); }
        public E getFirst()       { return nsee(map().firstEntry()); }
        public E getLast()        { return nsee(map().lastEntry()); }
        public E removeFirst(@GuardSatisfied @Modifiable SequencedSetFromMap<E> this)    { return nsee(map().pollFirstEntry()); }
        public E removeLast(@GuardSatisfied @Modifiable SequencedSetFromMap<E> this)     { return nsee(map().pollLastEntry()); }
    ...
    static class AsLIFOQueue<E> extends AbstractQueue<E>
        ...
        public boolean remove(@GuardSatisfied @Modifiable AsLIFOQueue<E> this, @UnknownSignedness Object o)             { return q.remove(o); }
        @SideEffectFree
