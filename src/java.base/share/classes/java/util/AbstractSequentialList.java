...
public abstract class AbstractSequentialList<E> extends AbstractList<E> {
     ...
     * @throws IndexOutOfBoundsException     {@inheritDoc}
     */
    public E set(@Modifiable @GuardSatisfied AbstractSequentialList<E> this, int index, E element) {
        try {
     ...
     * @throws IndexOutOfBoundsException     {@inheritDoc}
     */
    public void add(@Modifiable @GuardSatisfied AbstractSequentialList<E> this, int index, E element) {
        try {
     ...
     * @throws IndexOutOfBoundsException     {@inheritDoc}
     */
    public E remove(@Modifiable @GuardSatisfied @Shrinkable AbstractSequentialList<E> this, int index) {
        try {
            ListIterator<E> e = listIterator(index);
            E outCast = e.next();
            e.remove();
     ...
     * @throws IndexOutOfBoundsException     {@inheritDoc}
     */
    public boolean addAll(@Modifiable @GuardSatisfied AbstractSequentialList<E> this, int index, Collection<? extends E> c) {
        try {
     ...
     */
    @SideEffectFree
    public @PolyModifiable @PolyGrowShrink @PolyNonEmpty Iterator<E> iterator(@PolyModifiable @PolyGrowShrink @PolyNonEmpty AbstractSequentialList<E> this) {
        return listIterator();
    }
     ...
     * @throws IndexOutOfBoundsException {@inheritDoc}
     */
    public abstract @PolyModifiable @PolyGrowShrink ListIterator<E> listIterator(@PolyModifiable @PolyGrowShrink AbstractSequentialList<E> this, int index);
}
