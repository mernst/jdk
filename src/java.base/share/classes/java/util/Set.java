...
public interface Set<E> extends Collection<E> {
     ...
     */
    @Pure
    @NonNegative int size(@AnyModifiable @GuardSatisfied Set<E> this);
    ...
    boolean isEmpty(@AnyModifiable @GuardSatisfied Set<E> this);
    ...
    boolean contains(@AnyModifiable @GuardSatisfied Set<E> this, @GuardSatisfied @UnknownSignedness Object o);
     ...
     */
    @Pure
    boolean containsAll(@AnyModifiable @GuardSatisfied Set<E> this, @GuardSatisfied Collection<? extends @UnknownSignedness Object> c);
     ...
     */
    @Pure
    boolean equals(@AnyModifiable @GuardSatisfied Set<E> this, @GuardSatisfied @Nullable Object o);
     ...
     */
    @Pure
    int hashCode(@AnyModifiable @GuardSatisfied Set<E> this);
     ...
     */
    @SuppressWarnings("unchecked")
    static <E extends Object> @Unmodifiable @PolyNonEmpty Set<E> copyOf(@AnyModifiable @PolyNonEmpty Collection<? extends E> coll) {
